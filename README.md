...
|**[0x1A-hash_tables](https://github.com/ikwuka/alx-low_level_programming/tree/master/0x1A-hash_tables)**|0-hash_table_create.c, 1-djb2.c, 2-key_index.c, 3-hash_table_set.c, 4-hash_table_get.c, 5-hash_table_print.c, 6-hash_table_delete.c, 100-sorted_hash_table.c, README.md|
...
|**[0x17-doubly_linked_lists](https://github.com/ikwuka/alx-low_level_programming/tree/master/0x17-doubly_linked_lists)**|0-print_dlistint.c, 1-dlistint_len.c, 2-add_dnodeint.c, 3-add_dnodeint_end.c, 4-free_dlistint.c, 5-get_dnodeint.c, 6-sum_dlistint.c, 7-insert_dnodeint.c, 8-delete_dnodeint.c, lists.h, README.md|
|**[0x18-dynamic_libraries](https://github.com/ikwuka/alx-low_level_programming/tree/master/0x18-dynamic_libraries)**|100-operations.so, abs.c, isalpha.c, islower.c, liball.so, memcpy.o, _putchar.o, strcat.c, strcmp.c, strlen.c, strncpy.c, strspn.c, 100-tests.py, abs.o, isalpha.o, islower.o, libdynamic.so, memset.c, puts.c, strcat.o, strcmp.o, strlen.o, strncpy.o, strspn.o, 101-make_me_win.sh, atoi.c, isdigit.c, isupper.c, main.h, memset.o, puts.o, strchr.c, strcpy.c, strncat.c, strpbrk.c, strstr.c, 1-create_dynamic_lib.sh, atoi.o, isdigit.o, isupper.o, memcpy.c, _putchar.c, README.md, strchr.o, strcpy.o, strncat.o, strpbrk.o, strstr.o|
|                                      |                                            |
